 ...
 */
final class Version20260119145751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mouvement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type BOOLEAN DEFAULT NULL, date_heure DATETIME NOT NULL, nom_prenom VARCHAR(255) DEFAULT NULL, livre_id INTEGER DEFAULT NULL, CONSTRAINT FK_5B51FC3E37D925CB FOREIGN KEY (livre_id) REFERENCES livre (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
