/**
 * @fileName : modal_livre_details.js
 * @author : Dufour Marc (marc.dufour@stjosup.com)
 * @version : 1.0
 * @dateCreate : 06/02/2026
 * @lastUpdate : 11/02/2026 (ajout de l'entête)
 * @description : Gestion de la modale de détails des livres et de la modale de description
 * @dependencies : fonctions.js (chargerModale, openDescriptionModal, closeDescriptionModal, 
